...
extension PinningURLSessionDelegateTests {
    func testPinningDelegate_computeKeyHash_validCert_returnsNonNilHash() throws {
        ...
        let hash = PinningURLSessionDelegate.computeKeyHash(from: certificate)
        XCTAssertNotNil(hash)
        XCTAssertFalse(hash?.isEmpty ?? true)
    }

    func testPinningDelegate_computeKeyHash_sameCert_returnsSameHash() throws {
        let derHex = ""
        guard let derData = Data(hexString: derHex),
              let certificate = SecCertificateCreateWithData(nil, derData as CFData) else {
            XCTFail("Failed to create SecCertificate")
        ...
        let hash1 = PinningURLSessionDelegate.computeKeyHash(from: certificate)
        let hash2 = PinningURLSessionDelegate.computeKeyHash(from: certificate)
        XCTAssertEqual(hash1, hash2)
    }

    func testPinningDelegate_computeKeyHash_invalidCert_returnsNil() throws {
        ...
        let hash = PinningURLSessionDelegate.computeKeyHash(from: cert)
        XCTAssertNil(hash)
    }
}
