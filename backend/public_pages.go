...
:root{--bg:#07070B;--surface:#121216;--surface-alt:#18181D;--border:rgba(255,255,255,0.06);--border-hover:rgba(255,255,255,0.12);--blue:#0A84FF;--blue-dim:rgba(10,132,255,0.12);--amber:#FF6B35;--green:#30D158;--text:#F5F5F7;--muted:#98989D;--radius:12px}
...
.hero-eyebrow{display:inline-block;color:var(--blue);font-size:.8rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase;margin-bottom:20px}
...
.features{max-width:960px;margin:0 auto;padding:60px 24px 80px}
...
.feature-card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:24px;transition:border-color .15s,transform .15s}
...
.cta-banner{text-align:center;padding:60px 24px;border-top:1px solid var(--border);border-bottom:1px solid var(--border);background:var(--surface)}
.cta-banner h2{font-size:1.5rem;font-weight:700;margin-bottom:8px}
.cta-banner p{color:var(--muted);margin-bottom:24px;font-size:.95rem}
footer{max-width:960px;margin:0 auto;padding:24px;color:var(--muted);font-size:.85rem;display:flex;justify-content:space-between;flex-wrap:wrap;gap:12px}
...
<section class="hero">
  <div class="hero-eyebrow">FastTrack</div>
...
<div class="cta-banner">
  ...
  <p>Available on iOS. Browse the leaderboard or learn more about the app.</p>
  <div class="hero-cta">
    <a class="btn btn-primary" href="/leaderboard">View Leaderboard</a>
    <a class="btn btn-secondary" href="/privacy">Privacy Policy</a>
  </div>
